...
-|-|-
Continuous|Clustering&Dimensionality,Reduction(SVD,PCA,K-means)|Regression(Linear,Polynomial),Decision Tree,Random Forests
Categorical|Association Analysis(Aproori,FP-Growth),Hidden Markov Model | Classification(KNN,Trees,Logistic Regression,Naive-Bayes,SVM)
